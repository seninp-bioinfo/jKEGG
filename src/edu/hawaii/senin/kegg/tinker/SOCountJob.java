...
public class SOCountJob implements Callable<HashMap<String, Object>> {

  private KEGGDB db;
  private Integer tagId;
  private String koId;

  public SOCountJob(KEGGDB db, Integer id, String key) {
    this.db = db;
    this.tagId = id;
    this.koId = key;
  }
  ...
  public HashMap<String, Object> call() throws Exception {
    ...
    HashMap<String, Object> set = session.selectOne("selectTopOrganismSO", params);
